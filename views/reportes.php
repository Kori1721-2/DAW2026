...
<style>
    ...
    .reportes-container .text-bg-primary .card-title,
    .reportes-container .text-bg-primary h2,
    .reportes-container .text-bg-success .card-title,
    .reportes-container .text-bg-success h2,
    .reportes-container .text-bg-info .card-title,
    .reportes-container .text-bg-info h2,
    .reportes-container .text-bg-warning .card-title,
    .reportes-container .text-bg-warning h2,
    .reportes-container .text-bg-secondary .card-title,
    .reportes-container .text-bg-secondary h2,
    .reportes-container .text-bg-danger .card-title,
    .reportes-container .text-bg-danger h2 {
        color: #fff !important;
    }
    .reportes-container .card-header {
